...
public record OrderResponse(
    ...
    [property: Required(ErrorMessage = "Customer name is required"), StringLength(100, ErrorMessage = "Customer name cannot exceed 100 characters"), SwaggerSchema(Description = "The customer name")] string CustomerName, 
...
public record OrderItemResponse(
    ...
    [property: Range(1, 1000, ErrorMessage = "Quantity must be between 1 and 1000"), SwaggerSchema(Description = "The quantity")] int Quantity, 
...
public record CreateOrderRequest(
    [property: Required(ErrorMessage = "Customer name is required"), StringLength(100, ErrorMessage = "Customer name cannot exceed 100 characters"), SwaggerSchema(Description = "The customer name")] string CustomerName, 
    [property: Required(ErrorMessage = "Order items are required"), SwaggerSchema(Description = "The items")] IReadOnlyList<CreateOrderItemRequest> Items);
